...
Donate link: http://www.techxperts.co.in/
...
The Colorful Tag Cloud Widget is a widget that displays your categories and tag as a Colorful cloud in your sidebar. You can also insert Colorful Tag Cloud 
in your post or page by simply adding [colorful_tag_cloud] in your post or page.
...
* [colorful_tag_cloud] : You can also insert Colorful Tag Cloud in your post or page by simply adding [colorful_tag_cloud] in your post or page.

== Installation ==

1. First copy this plugin to your `/wp-content/plugins/'
2. Activate this plugin from Wordpress->admin->Plugins
3. Go to Appearance->Widget and drag and drop the widget to wherever you want to show it.
4. Use the configuration menu to customise the widget.
...
= How can I add Colorful Tag Cloud in my post or page? =

You can insert Colorful Tag Cloud in your post or page by simply adding [colorful_tag_cloud] in your post or page. And it will be replaced by Colorful Tag Cloud.
